...
// ForEachChild iterates each child property of the current property and invokes callback. The method returns any error
// generated previously or generated by any of the callbacks.
