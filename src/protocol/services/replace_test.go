			...
			setup: func(t *testing.T) *ReplaceService {
				...
				return &ReplaceService{
					...
					Filters: []protocol.ResourceFilter{
						...
						filters.NewCopyReadOnlyResourceFilter(resourceType, 1),
						filters.NewPasswordResourceFilter(10, 200),
						filters.NewValidationResourceFilter(resourceType, memoryPersistence, 300),
						filters.NewMetaResourceFilter(400),
					},
